...
export interface LicenseSnapshot {
  ...
  publishingSplit: PublishingSplit;
  commonTerms: typeof licenseTermsJson.global.common_terms;
}
...
export const GOVERNING_LAW =
  licenseTermsJson.global.common_terms.governing_law;
...
/** Check if a contractual cap is unlimited (-1). */
...
export function createLicenseSnapshot(
  ...
  return {
    ...
    commonTerms: JSON.parse(
      JSON.stringify(licenseTermsJson.global.common_terms)
    ) as typeof licenseTermsJson.global.common_terms,
  };
}

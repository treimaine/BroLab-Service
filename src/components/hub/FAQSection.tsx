...
const FAQS = [
  {
    ...
    answer: 'BroLab takes 0% commission on sales. You keep 100% of your revenue. You only pay the standard Stripe processing fees (around 2.9% + $0.30 per transaction). Your subscription covers platform access.',
  },
  {

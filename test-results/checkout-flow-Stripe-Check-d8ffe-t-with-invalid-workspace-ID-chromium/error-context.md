...
- Name: checkout-flow.spec.ts >> Stripe Checkout Flow - Error Scenarios (P1) >> should reject checkout with invalid workspace ID
- Location: tests\e2e\checkout-flow.spec.ts:231:7
...
Received string:    "Unauthorized. Please sign in to make a purchase."
```

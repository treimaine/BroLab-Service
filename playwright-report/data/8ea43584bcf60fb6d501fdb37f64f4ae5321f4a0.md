...
- Name: checkout-flow.spec.ts >> Stripe Checkout Flow - Happy Paths (P0) >> should handle order creation and all database mutations
- Location: tests\e2e\checkout-flow.spec.ts:189:7
